                                ...
                                <table class="table table-bordered mb-0" id="customerTable">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($q)) {
                                            ...
                                            echo '<button class="calendar-icon" onclick="showDatePicker(' . $row['id'] . ', \'act_date\')">&#128197;</button>';
                                            echo '</td>';
                                            ...
                                            echo '<button class="calendar-icon" onclick="showDatePicker(' . $row['id'] . ', \'end_date\')">&#128197;</button>';
                                            echo '</td>';
                                            $user_id = $row['user_id'];
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item activate-btn" href="#" data-id="' . $row['id'] . '">Activate</a>
                                                    <a class="dropdown-item deactivate-btn" href="#" data-id="' . $row['id'] . '">Deactivate</a>
