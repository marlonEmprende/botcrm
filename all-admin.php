  ...
  <div class="content-wrapper">
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title">All Admin</h3>
      </div>
                ...
                <table class="table table-bordered mb-0" id="resellerTable">
                  ...
                  <tbody>
                    ...
                    if ($_SESSION['user_type'] == 'admin') {
                      $q = mysqli_query($conn, "SELECT `id`,`username`, `name`, `contact_number`, `password`, `user_type`,`start_date`, `expired_date`, `status` FROM `admin` WHERE `user_type` = 'user' AND `deleted` != 'yes'");
...
<!-- 
<div class="dropdown-divider"></div>
                     <a class="dropdown-item activateall-btn" href="#" data-id="' . $id . '">Activate With Reseller</a>
                    <a class="dropdown-item deactivateall-btn" href="#" data-id="' . $id . '">Deactivate With Reseller</a> -->
...
<script>
  ...
  //     success: function (response) {
  //       alert(response.message); // Display message from JSON response
  //       // Optionally, refresh the page or update the table view here
  //     },
  //     error: function (jqXHR, textStatus, errorThrown) {
  //       alert("An error occurred: " + textStatus); // Show error message
  //     }
  //   });
  // }
